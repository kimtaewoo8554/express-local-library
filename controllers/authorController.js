...
exports.author_create_post = function(req, res, next) {
    ...
    req.checkBody('date_of_death', '').optional({ checkFalsy: true }).isDate();
...
exports.author_update_post = function(req, res, next) {
    ...
    //Check other Data
    req.checkBody('first_name', 'Frist name must not be empty.').notEmpty();
    ...
    if (errors) {
      ...
      // Data from form is vaild. Update the record
